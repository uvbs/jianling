...
const
  ...
  function VMProtectActivateLicense(ActivationCode: PAnsiChar; Buffer: PAnsiChar; BufferLen: Integer): Integer; stdcall;
  function VMProtectDeactivateLicense(SerialNumber: PAnsiChar): Integer; stdcall;
  function VMProtectGetOfflineActivationString(ActivationCode: PAnsiChar; Buffer: PAnsiChar; BufferLen: Integer): Integer; stdcall;
  function VMProtectGetOfflineDeactivationString(SerialNumber: PAnsiChar; Buffer: PAnsiChar; BufferLen: Integer): Integer; stdcall;
...
function VMProtectActivateLicense(ActivationCode: PAnsiChar; Buffer: PAnsiChar; BufferLen: Integer): Integer; stdcall; external VMProtectDLLName;
function VMProtectDeactivateLicense(SerialNumber: PAnsiChar): Integer; stdcall; external VMProtectDLLName;
function VMProtectGetOfflineActivationString(ActivationCode: PAnsiChar; Buffer: PAnsiChar; BufferLen: Integer): Integer; stdcall; external VMProtectDLLName;
function VMProtectGetOfflineDeactivationString(SerialNumber: PAnsiChar; Buffer: PAnsiChar; BufferLen: Integer): Integer; stdcall; external VMProtectDLLName;
