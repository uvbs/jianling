...
BOOL CJLkitDoc::OnNewDocument()
{
    ...
    m_bRememberPassWord =	AfxGetApp()->GetProfileInt(_T("设置"), _T("记住密码"), 0);
    ...
    m_pLoginDlg->bRemPw = m_bRememberPassWord;
...
void CJLkitDoc::OnCloseDocument() 
{
    ...
    //保存设置
    AfxGetApp()->WriteProfileInt(_T("设置"), _T("记住密码"), m_bRememberPassWord);
