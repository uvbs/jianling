...
void TaskScript::Task_497(int zid,int taskid)
{
	...
	case 1:
		...
		break;
	case 2:
		gcall.DeliverQuests(497, 2, NULL,1,0,1);
		Sleep(1000);
		gcall.NewBag();
		Sleep(6000);
		break;
...
void TaskScript::Task_304(int zid,int taskid)
{
	...
	case 2:
		...
		Sleep(1000);
		gcall.DeliverQuests(0x141, 1, NULL, 0, 0, 1);
		Sleep(1000);
		gcall.DeliverQuests(0x141, 2, NULL, 0, 0, 1);
		Sleep(1000);
		gcall.DeliverQuests(0x141, 3, NULL, 0, 0, 1);
		Sleep(1000);
		gcall.DeliverQuests(0x141, 4, NULL, 0, 0, 1);
		Sleep(1000);
		gcall.DeliverQuests(0x551, 1, NULL, 0, 0, 1);
		Sleep(1000);
		gcall.DeliverQuests(0x551, 2, NULL, 1);
		Sleep(1000);
		/*支线任务结束*/
...
void TaskScript::Task_307(int zid,int taskid)
{
	...
	case 4:
		...
		//{
			//_BAGSTU goods;
			//gcall.GetGoodsByEquipPos(WUQI, &goods);
			...
			//		//gcall.WearEquipment(L"???? 1??", WUQI);
			//		//Sleep(500);
			//		//gcall.WearEquipment(L"???? 2??", WUQI);
			//		//Sleep(500);
			//		//gcall.WearEquipment(L"???? 3??", WUQI);
			//		//Sleep(500);
			//		//gcall.WearEquipment(L"???? 4??", WUQI);
			//		//Sleep(500);
			//		//gcall.WearEquipment(L"???? 5??", WUQI);
			//		//Sleep(500);
			//		//gcall.HeChengWuQi(WUQI);
			//		//Sleep(2000);
			//		//gcall.HeChengWuQiByHun(WUQI);
			//		//Sleep(2000);
			//		gcall.HeChengWuQi_Po5(WUQI, L"????");
			//		Sleep(2000);
			//		/*				gcall.LinQuJiangLi();
			//						Sleep(2000);
			//						gcall.JiaBaoShi(0, L"?? ???");
...
void TaskScript::Task_311(int zid,int taskid)
{
	...
	case 8:
		...
		gcall.DeliverQuests(311,taskid,L"???");
		Sleep(1000);
		gcall.WearEquipment(L"???? 1??",JIEZHI);
		Sleep(1000);
		
		IsGoonHecheng(JIEZHI);
...
void TaskScript::Task_314(int zid,int taskid)
{
	...
	case 1:
		...
		IsGoonHecheng(WUQI);
		//执行3次合成武魂，保证到10.
		gcall.WearEquipment(L"????? 1??",XIANGLIAN);
		Sleep(1000);
		IsGoonHecheng(XIANGLIAN);
		Sleep(1000);
...
void TaskScript::Task_315(int zid,int taskid)
{
	...
	{
	case 1:
		gcall.WearEquipment(L"????? 1??",ERHUAN);
		Sleep(1000);
		IsGoonHecheng(ERHUAN);
		Sleep(1000);
		gcall.NewSpend(2.5);
...
void TaskScript::Task_319(int zid,int taskid)
{
	...
	case 1:
		...
		//gcall.XieBaoShi(1);
		//Sleep(1000);
		///*gcall.XieZhuangBei(WUQI);
		//Sleep(1000);*/
		//_BAGSTU zhu;
		//while (true)
		//{
		//	ZeroMemory(&zhu,sizeof(_BAGSTU));
		//	gcall.GetGoodsByEquipPos(WUQI, &zhu);
		//	
		//	if (zhu.name != NULL)
		//	{
