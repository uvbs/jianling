...
//  Warnings
/////////////////////
// warning C4312: 'type cast' : conversion from <type> to <type> of greater size
...
public:
    ...
    bool Hook(FARPROC hookFrom, FARPROC hookTo)
    {
        return Hook(hookFrom, hookTo, Normal);
    };
    ...
    {
        return DebugHook(hookFrom, hookTo, Normal);
    };
    ...
    bool HookIAT(FARPROC hookFrom, FARPROC hookTo, HMODULE target)
    {
        return HookIAT(hookFrom, hookTo, target, Normal);
    };
    ...
    {
        return HookEAT(hookFrom, hookTo, Normal);
    };
