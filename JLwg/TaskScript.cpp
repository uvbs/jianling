...
FunTask ft[0x400] =
{
	...
	{ TEXT("514"), &TaskScript::Task_514 },//2-
	{ TEXT("515"), &TaskScript::Task_515 },//2-
...
void TaskScript::Task_514(int zid,int taskid)
{
	...
	case 1:
		...
		gcall.XieBaoShi(1);
		Sleep(1000);
		gcall.JiaBaoShi(0,L"??? ?? ???");//5角紫宝石

		Sleep(1000);
		gcall.JiaBaoShi(1,L"??? ?? ??");//4角红宝石
	...
	case 2:
		...
		gcall.NewSpend(2.5);
		gcall.Stepto(-5198,-57148,-1449);
		gcall.Stepto(-5189,-56952,-1466);
	...
	case 3:
		gcall.NewSpend(2.5);
		gcall.Stepto(27349,-43564,-1587);
		gcall.Stepto(27348,-43570,-1587);
		gcall.Stepto(27319,-43812,-1589);
		...
		gcall.NewSpend(2.5);
		gcall.Stepto(-3839,-57584,-1335);
		gcall.Stepto(-3869,-57573,-1337);
		gcall.Stepto(-4055,-57503,-1357);
...
void TaskScript::Task_515(int zid,int taskid)
{
	...
	{
	case 1:
		MessageBox(0, L"515", L"装八卦", MB_OK);
		break;
	case 2:
		break;
	case 3:
...
void TaskScript::IsGoonHecheng(DWORD pos)
{
	...
	for (int i = 0;i < 10;i++)
	{
		...
		}else
		{
			...
			{
				gcall.HeChengWuQiByHun((EQUITMENT_POS)pos);//????36级首饰魂
