...
CCHook::CCHook(void* CallAddr, void* NewCall, BOOL bAutoDel)
{
...
void CCHook::Init(void* CallAddr, void* NewCall, BOOL bAutoDel)
{
...
//返回根据函数头分析需要修补的大小
BOOL CCHook::GetPatchSize(void* Proc, DWORD dwNeedSize, LPDWORD lpPatchSize)
{
    DWORD Length;
    PUCHAR pOpcode;
    DWORD PatchSize = 0;
