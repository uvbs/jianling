...
inline BOOL Toolhelp::EnableDebugPrivilege(BOOL fEnable) 
{
...
inline BOOL Toolhelp::HeapFirst(PHEAPENTRY32 phe, DWORD dwProcessID, 
								 UINT_PTR dwHeapID) const {
...
inline BOOL Toolhelp::IsAHeap(HANDLE hProcess, PVOID pvBlock, 
